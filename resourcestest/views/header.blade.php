...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="index2.html" class="logo"><b>System </b>Portal</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ asset("img/prof.jpg") }}" class="user-image" alt="User Image"/>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ Auth::user()->name }}
                                <small>Main Administrator  of the  System</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
