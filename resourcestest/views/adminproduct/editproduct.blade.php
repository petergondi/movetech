                        ...
                        <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Update {{$result->bussinessname}} Product </strong>Separate Features with a comma ',' for a any new feature.
                                        <a  href="{{route('viewvendorproducts',['id'=>$vendorid])}}" class="btn btn-outline-primary btn-sm"><i class="fa fa-pencil"></i> all products</a>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <form  name="form1" id='form1' class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('adminvendorupdate_product') }}">
                                                            {{ csrf_field() }}
