...
<head>
    ...
    <!-- jvectormap --
    <link rel="stylesheet" href="{{ asset("public/bower_components/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css")}}">
    <!-- Date Picker --
    ...
    <link rel="stylesheet" href="{{asset('public/css/progresspopup.css')}}" >
    <!--progress  when saving data css-->


    <!-- setting the  date  to date field -->
    <link rel="stylesheet" href="{{asset('public/datepicker2/css/datepicker.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('public/css/iconleft.css')}}" >
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset("public/bower_components/AdminLTE/https://code.jquery.com/ui/1.11.4/jquery-ui.min.js")}}"></script>
...
<script src="{{ asset("public/bower_components/AdminLTE/plugins/morris/morris.min.js")}}"></script>
<!-- Sparkline -->
<script src="{{ asset("public/bower_components/AdminLTE/plugins/sparkline/jquery.sparkline.min.js")}}"></script>
<!-- jvectormap -->
<script src="{{ asset("public/bower_components/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js")}}"></script>
<script src="{{ asset("public/bower_components/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js")}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset("public/bower_components/AdminLTE/plugins/knob/jquery.knob.js")}}"></script>
<!-- daterangepicker -->
...
<script src="{{ asset("public/bower_components/AdminLTE/dist/js/pages/dashboard.js")}}"></script>
