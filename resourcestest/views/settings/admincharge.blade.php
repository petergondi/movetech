                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Admin Charge Rate</strong>
                                    </div>
                                    <div class="card-body">
                                        <center>
                                        ...
                                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                <form  name="form1" id='form1' class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('save-charge') }}">
                                                            {{ csrf_field() }}
                                                            @if($result)
                                                    ...
                                                    <td>
                                                                                @if($result) 
                                                                                <input class="form-control" type="text" id="fee" value="{{ $result->fee }}" name="fee >
                                                                                @else
                                                                                <input class="form-control" type="text" id="fee" value="{{ old('fee') }}" name="fee" >
                                                                                @endif 
                                                                            <small class="form-text text-muted">
                                                                            
                                                                                @if ($errors->has('fee'))
                                                                                        <span class="help-block">
                                                                                            <font color='red'>{{ $errors->first('fee') }}</font>
                                                                                        </span>
                                                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{$result->fee}} </td>
                                                    <td> 
                                                        <a  href="{{route('edit-charge',['id'=>$result->id])}}" class="btn btn-outline-primary btn-sm"><i class="fa fa-pencil"></i> view </a>
