                        ...
                        <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Update Product </strong>Separate Features with a comma ',' for a any new feature.
                                    </div>
                                    <div class="card-body">
                                                <center>
                                            ...
                                            <form  name="form1" id='form1' class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('vendorupdate_product') }}">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <hr>
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="row form-group">
                                                                        ...
                                                                        <div class="col-12 col-md-9">
                                                                             <img src="{{asset("public/imageupload/".$result->imageurl)}}"  alt="No Image">
