                        ...
                        <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">New Product </strong>Separate Features with a comma ',' for a any new feature.
                                    </div>
                                    <div class="card-body">
                                                <center>
                                            ...
                                            <form  name="form1" id='form1' class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('vendorsubmit_newproduct') }}">
                                                            {{ csrf_field() }}
                                        <div class="row">
                                                    <div class="col-md-6">
