            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="{{ route('show_reset_vendor_acc') }}" class="signup-image-link">Reset password</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form class="register-form" id="login-form"method="POST" action="{{ route('submit_vendor_login') }}">
                            {{ csrf_field() }}
